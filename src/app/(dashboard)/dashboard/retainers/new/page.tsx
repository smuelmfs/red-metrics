...
export default function NewRetainerPage() {
    ...
    if (catalogItem) {
      setFormData({
        ...
        hoursPerMonth: catalogItem.hoursPerMonth
          ? Number(catalogItem.hoursPerMonth)
          : null,
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (
        formData.hoursPerMonth !== null &&
        formData.hoursPerMonth !== undefined
      )
        payload.hoursPerMonth = formData.hoursPerMonth;
      if (
        formData.variableCostPerMonth !== null &&
        formData.variableCostPerMonth !== undefined
      )
        payload.variableCostPerMonth = formData.variableCostPerMonth;
        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Ao selecionar um item do catálogo, os campos serão preenchidos
              automaticamente
            </p>
          </div>
