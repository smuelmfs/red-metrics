...
export default async function RetainersPage() {
  ...
  const retainers = await prisma.retainer.findMany({
    ...
    orderBy: [{ department: { name: "asc" } }, { startDate: "desc" }],
  });
  ...
  const serializedRetainers = retainers.map((retainer) => ({
    ...
    hoursPerMonth: retainer.hoursPerMonth
      ? Number(retainer.hoursPerMonth)
      : null,
    variableCostPerMonth: retainer.variableCostPerMonth
      ? Number(retainer.variableCostPerMonth)
      : null,
