...
export async function PATCH(
  ...
  try {
    ...
    const monthlyPrice =
      validatedData.monthlyPrice ?? Number(existing.monthlyPrice);
    ...
    const updated = await prisma.retainer.update({
      ...
      data: {
        ...
        variableCostPerMonth:
          validatedData.variableCostPerMonth ?? existing.variableCostPerMonth,
        monthlyChurn: validatedData.monthlyChurn ?? existing.monthlyChurn,
        newRetainersPerMonth:
          validatedData.newRetainersPerMonth ?? existing.newRetainersPerMonth,
