    ...
    return (
      <div className="bg-white rounded-lg shadow-md p-6 border border-gray-200">
        ...
        <p className="text-sm text-gray-500 text-center">
          Salve horas faturáveis e objetivos, depois clique em "Recalcular
          Resultados"
        </p>
      </div>
    );
    ...
    <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
      <div className="p-4 lg:p-6 border-b border-gray-200 bg-gray-50">
        <h3 className="text-lg lg:text-xl font-bold text-gray-900">
          Classificação de Departamentos
        </h3>
        <p className="text-sm text-gray-600 mt-1">
          Ordenado por performance (melhor para pior)
        </p>
      </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-4 flex-wrap">
                    {/* Performance */}
                    <div
                      className={`px-3 py-1 rounded-full ${getStatusBadgeClasses(dept.status)}`}
                    >
                    ...
                    <div className="text-sm text-gray-600">
                      <span className="font-medium">
                        €
                        {dept.totalRevenue.toLocaleString("pt-BR", {
                    ...
                    {dept.objective && (
                      <div className="text-xs text-gray-500">
                        Obj: €
                        {dept.objective.toLocaleString("pt-BR", {
                          minimumFractionDigits: 2,
                        })}
                      </div>
                    )}
