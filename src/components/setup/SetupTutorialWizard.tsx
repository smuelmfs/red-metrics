          ...
          currentStepData.id !== "complete" && (
            <div className="flex justify-between items-center pt-6 border-t border-gray-200">
              ...
              <div className="flex gap-2">
                {currentStepData.id === "fixed-costs" ||
                currentStepData.id === "retainers" ? (
                  <button
                    onClick={handleSkip}
  ...
  return (
    <div className="text-center py-8">
      ...
      <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
        Este assistente vai guiá-lo passo a passo na criação de todos os
        elementos necessários para o sistema funcionar corretamente. Vamos
        começar?
      </p>
      <button
        onClick={onNext}
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <p className="text-sm text-blue-800">
          <strong>💡 Dica:</strong> Estas configurações são usadas em todos os
          cálculos do sistema. Você pode alterá-las depois em Configurações.
        </p>
      </div>
      ...
      {settings.map((setting) => (
        <div key={setting.key}>
          ...
          <input
            type={
              setting.key === "overheadPeople" ||
              setting.key === "hoursPerMonth"
                ? "number"
                : "text"
            }
            step={
              setting.key === "targetMargin" ||
              setting.key === "targetUtilization"
                ? "0.01"
                : "1"
            }
            value={setting.value}
...
function DepartmentStep({ onNext, data, setData }: StepComponentProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <p className="text-sm text-blue-800">
          <strong>💡 Dica:</strong> Você pode criar mais departamentos depois na
          página de Departamentos. Por enquanto, vamos criar o primeiro.
        </p>
      </div>
...
function PlannedHoursStep({ onNext, data, setData }: StepComponentProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <p className="text-sm text-blue-800">
          <strong>💡 Dica:</strong> Configure as horas planejadas para o mês
          atual. Você pode adicionar mais meses depois na página de Horas
          Planejadas.
        </p>
      </div>
        ...
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              setFormData({
                ...formData,
                targetHoursPerMonth: parseFloat(e.target.value) || 0,
              })
            }
            className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500"
          />
      ...
      <div>
        ...
        <input
          ...
          onChange={(e) =>
            setFormData({
              ...formData,
              actualBillableHours: e.target.value
...
function ObjectiveStep({ onNext, data, setData }: StepComponentProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6">
        <p className="text-sm text-blue-800">
          <strong>💡 Dica:</strong> O objetivo mínimo é usado para calcular a
          performance do departamento. Você pode definir objetivos diferentes
          para cada mês.
        </p>
      </div>
    ...
    <div className="space-y-6">
      <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
        <p className="text-sm text-yellow-800">
          <strong>ℹ️ Opcional:</strong> Você pode pular este passo e configurar
          custos fixos depois.
        </p>
      </div>
      ...
      <div className="bg-gray-50 rounded-lg p-6 text-center">
        ...
        <p className="text-gray-600 mb-4">
          Para adicionar custos fixos, vá para a página de{" "}
          <strong>Custos Fixos</strong> no menu.
        </p>
        <Link
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-gray-50 rounded-lg p-6 text-center">
        ...
        <p className="text-gray-600 mb-4">
          Para criar retainers (avenças), vá para a página de{" "}
          <strong>Retainers</strong> no menu.
        </p>
        <Link
